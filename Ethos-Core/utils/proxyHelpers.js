...
class Proxy {
  ...
  async proxyFunctionWithUserAndCollateral(functionName, user, collAddress) {
    return this.contract[functionName](this.getProxyAddressFromUser(user), collAddress)
  }
...
class BorrowerWrappersProxy extends Proxy {
  ...
  async claimCollateralAndOpenTrove(...params) {
    return this.forwardFunction(params, 'claimCollateralAndOpenTrove(address,uint256,uint256,uint256,address,address)')
  }

  async claimSPRewardsAndRecycle(...params) {
    return this.forwardFunction(params, 'claimSPRewardsAndRecycle(address,uint256,address,address)')
  }

  async claimStakingGainsAndRecycle(...params) {
    return this.forwardFunction(params, 'claimStakingGainsAndRecycle(address,uint256,address,address)')
  }

  async transferERC20(...params) {
    return this.forwardFunction(params, 'transferERC20(address,address,uint256)')
  }
}
...
class TroveManagerProxy extends Proxy {
  ...
  async getTroveStatus(user, collAddress) {
    return this.proxyFunctionWithUserAndCollateral('getTroveStatus', user, collAddress)
  }

  async getTroveDebt(user, collAddress) {
    return this.proxyFunctionWithUserAndCollateral('getTroveDebt', user, collAddress)
  }

  async getTroveColl(user, collAddress) {
    return this.proxyFunctionWithUserAndCollateral('getTroveColl', user, collAddress)
  }
  ...
  async liquidate(user, collAddress) {
    return this.proxyFunctionWithUserAndCollateral('liquidate', user, collAddress)
  }
  ...
  async getCurrentICR(user, collAddress, price) {
    return this.contract.getCurrentICR(this.getProxyAddressFromUser(user), collAddress, price)
  }
